...
export default function AuthorizationInfo() {
    ...
    const handleAgree = async () => {
        ...
        setTimeout(() => {
            // Redirect to wallet page after agreement
    ...
    return (
        <div className="w-[390px] h-[844px] mx-auto bg-[#F5F5F6] rounded-[40px] relative overflow-hidden">
            ...
            {/* Question Heading */}
            <div className="absolute left-[49px] top-[185px] w-[248px] h-[62px]">
                <h1 className="font-poppins font-medium text-[24px] leading-[36px] text-[#563DDE]">Wat betekent het als je mij machtigt?</h1>
            </div>

            {/* Information Text */}
            <div className="absolute left-[49px] top-[283px] w-[297px] h-[399px]">
                <p className="font-poppins font-medium text-[16px] leading-[24px] text-black">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc aliquet lorem quis turpis posuere, ac ornare purus pretium. Proin vel molestie lacus, a tincidunt arcu. Curabitur lobortis vel arcu a porta. Morbi tempor tortor sed ante viverra hendrerit. Praesent augue nibh, aliquam a iaculis ut, feugiat at purus. Curabitur lobortis vel arcu a porta. Morbi tempor tortor sed ante viverra hendrerit. Praesent augue nibh, aliquam a iaculis ut, feugiat at purus.
                </p>
            </div>
                ...
                >
                    <div className="w-full h-[51px] flex items-center justify-center">
                        {isAgreeing ? (
                            ...
                            <span className="font-poppins font-medium text-[20px] leading-[30px] text-white text-center">Akkoord</span>
                        )}
                    </div>
                </button>
            </div>
